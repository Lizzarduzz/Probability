# Create a Monte Carlo simulation to confirm your answer to the previous problem by estimating
# how frequently the Celtics win at least 1 of 4 games. Use B <- 10000 simulations.
